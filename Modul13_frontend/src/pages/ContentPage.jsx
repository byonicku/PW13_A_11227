    ...
    <Container className="mt-4">
      ...
      {isLoading ? (
        ...
        <Table striped bordered hover>
          <thead>
            <tr>
              <th>No</th> <th style={{ width: "200px" }}>Thumbnail</th>
              <th>Title</th> <th>Description</th> <th>Action</th>
            </tr>
          </thead>
          <tbody>
            {contents?.map((content, index) => (
              <tr key={content.id}>
                ...
                <td>{content.title}</td> <td>{content.description}</td>
                <td>
                  <Stack direction="horizontal" gap={2}>
                    ...
                    {isPending ? (
                      ...
                      >
                        <FaTrash className="mx-1 mb-1" /> Hapus
                      </Button>
                    )}
                  </Stack>
                </td>
